...
if("TRUE" STREQUAL "TRUE")
  set(multirobot_map_merge_SOURCE_PREFIX /home/parallels/catkin_ws/src/m-explore/map_merge)
  set(multirobot_map_merge_DEVEL_PREFIX /home/parallels/catkin_ws/devel)
  ...
  set(multirobot_map_merge_INSTALL_PREFIX /home/parallels/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'multirobot_map_merge' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jiri Horner <laeqten@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'multirobot_map_merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parallels/catkin_ws/src/m-explore/map_merge/${idir}'.  Ask the maintainer 'Jiri Horner <laeqten@gmail.com>' to fix it.")
    endif()
