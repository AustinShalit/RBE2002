...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/parallels/catkin_ws/src/differential-drive)
  set(differential_drive_DEVEL_PREFIX /home/parallels/catkin_ws/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/parallels/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jon Stephan <jfstepha@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parallels/catkin_ws/src/differential-drive/${idir}'.  Ask the maintainer 'Jon Stephan <jfstepha@gmail.com>' to fix it.")
    endif()
