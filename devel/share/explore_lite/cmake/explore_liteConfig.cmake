...
if("TRUE" STREQUAL "TRUE")
  set(explore_lite_SOURCE_PREFIX /home/parallels/catkin_ws/src/m-explore/explore)
  set(explore_lite_DEVEL_PREFIX /home/parallels/catkin_ws/devel)
  ...
  set(explore_lite_INSTALL_PREFIX /home/parallels/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'explore_lite' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jiri Horner <laeqten@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'explore_lite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parallels/catkin_ws/src/m-explore/explore/${idir}'.  Ask the maintainer 'Jiri Horner <laeqten@gmail.com>' to fix it.")
    endif()
